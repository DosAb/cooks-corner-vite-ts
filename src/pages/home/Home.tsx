        ...
        <div className="home">
          ...
          <div className="home__category">
            ...
            <div className="home__category-list">
              <button
                onClick={handleBreakfastFocus}
                className={breakfastFocus ? "focused" : ""}
                autoFocus
              >
                Breakfast
              </button>
              <button
                onClick={handleLunchFocus}
                className={lunchFocus ? "focused" : ""}
              >
                Lunch
              </button>
              <button
                onClick={handleDinnerFocus}
                className={dinnerFocus ? "focused" : ""}
              >
                Dinner
              </button>
            </div>
